...
| Файл | Призначення |
|------|-------------|
| [`github-dlya-chainykiv.html`](github-dlya-chainykiv.html) | Сама сторінка (HTML + CSS + JS в одному файлі) |
| [`CONTRIBUTING.md`](CONTRIBUTING.md) | Як ми працюємо над проєктом удвох |

## Як переглянути

Відкрий `github-dlya-chainykiv.html` у браузері подвійним кліком — жодних залежностей чи збірки не потрібно.
